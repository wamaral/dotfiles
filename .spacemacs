...
(custom-set-variables
 ...
 '(exec-path
   (quote
    ("/home/wamaral/bin" "/usr/local/sbin" "/usr/local/bin" "/usr/sbin" "/usr/bin" "/usr/lib/emacs/25.1.50/x86_64-unknown-linux-gnu")))
